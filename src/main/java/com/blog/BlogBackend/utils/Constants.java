...
public class Constants {
    ...
    public static String USER_NOT_VALID = "User not valid!";
    public static String COMMENT_NOT_FOUND = "Comment not found!";
    public static String NOT_AUTHENTICATED = "User not authenticated!";
